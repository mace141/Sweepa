...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  outline: 0;\n  font: inherit;\n  font-size: inherit;\n  color: inherit;\n  text-align: inherit;\n  text-decoration: inherit;\n  vertical-align: inherit;\n  box-sizing: inherit;\n  background: transparent;\n}\n\nul {\n  list-style: none;\n}\n\nimg {\n  display: block;\n  width: 100%;\n  height: auto;\n}\n\nbutton {\n  cursor: pointer;\n}\n\nheader {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  margin: 15px;\n}\n\n.top-nav, .bottom-nav, .links, .info-btns, .object-btns, .option-btns {\n  display: flex;\n}\n\n.top-nav {\n  justify-content: space-between;\n  position: relative;\n}\n.top-nav a {\n  margin-right: 10px;\n}\n\n.bottom-nav {\n  position: absolute;\n  top: 47px;\n  right: 50%;\n  transform: translate(575px);\n}\n.bottom-nav button {\n  white-space: nowrap;\n}\n\nh1.center {\n  font-weight: bold;\n  font-size: 32px;\n  transform: translate(-50%, -5px);\n}\n\nbutton {\n  padding: 5px 15px;\n  color: #12407c;\n  background: white;\n  border-radius: 5px;\n}\n\n.button {\n  box-shadow: 0 7px #999;\n}\n\n.button:hover {\n  background-color: #eeeeee;\n}\n\n.button:active, button.selected {\n  background-color: #eeeeee;\n  box-shadow: 0 4px #666;\n  transform: translateY(4px);\n}\n\n#start-btn {\n  margin: 0 100px;\n}\n\n.center {\n  position: absolute;\n  left: 50%;\n  transform: translate(-50%);\n}\n\n.object-btns > div, .option-btns > div {\n  margin: 0 10px;\n}\n\n.dropdown-ctnr {\n  position: relative;\n  margin-left: 10px;\n}\n\n.dropdown-ctnr:hover .dropdown {\n  display: block;\n}\n\n.dropdown {\n  display: none;\n  position: absolute;\n  z-index: 10;\n  right: 0;\n  background: white;\n  color: #12407c;\n  width: 300px;\n  height: auto;\n  padding: 10px;\n  border-radius: 5px;\n  font-size: 18px;\n  box-shadow: 0px 0px 10px -3px gray;\n  text-align: center;\n}\n\n.dropdown.search {\n  padding: 0;\n  white-space: nowrap;\n  transform: translate(calc(50% - 36px));\n  overflow: hidden;\n}\n.dropdown.search li {\n  padding: 5px 0;\n}\n.dropdown.search li:hover {\n  background: #e2e2e2;\n  cursor: pointer;\n}\n\n#grid {\n  margin: 0 auto;\n  margin-top: 76px;\n  width: max-content;\n  background: white;\n  border: 1px solid #bef5ff;\n}\n\n.node {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: white;\n  border: 1px solid #bef5ff;\n  width: 25px;\n  height: 25px;\n}\n\n.swept div {\n  height: 15px;\n  width: 15px;\n  background: #ffdfc2;\n  border-radius: 50%;\n  transition: 0.2s;\n}\n\n.row {\n  display: flex;\n}\n\n.home {\n  background: #47a18b;\n}\n\n.sweepa div {\n  height: 25px;\n  width: 25px;\n  background: #12407c;\n  border-radius: 50%;\n  transition: 0.05s;\n}\n\n@keyframes visited {\n  0% {\n    background: #1e3ce4;\n  }\n  100% {\n    background: #fbc5f9;\n  }\n}\n@keyframes visited {\n  0% {\n    background: #1ec6e4;\n  }\n  100% {\n    background: #2f62ee;\n  }\n}\n.visited {\n  animation-name: visited;\n  animation-duration: 1.5s;\n  background: #2f62ee;\n}\n\n.return {\n  background: white;\n}\n\n.wall {\n  border: 1px solid gray;\n  background: gray;\n  transition: 0.2s;\n}\n.wall div {\n  background: gray;\n  height: 15px;\n  width: 15px;\n  transition: 0.2s;\n}\n\nbody {\n  color: white;\n  background: #12407c;\n  font-size: 24px;\n  font-family: \"Segoe UI Symbol\", Helvetica, Arial, sans-serif;\n}", "",{"version":3,"sources":["webpack://./src/stylesheets/reset.scss","webpack://./src/stylesheets/main.scss","webpack://./src/stylesheets/header.scss","webpack://./src/stylesheets/constants.scss","webpack://./src/stylesheets/grid.scss"],"names":[],"mappings":"AAAA;EACE,SAAA;EACA,UAAA;EACA,SAAA;EACA,UAAA;EACA,aAAA;EACA,kBAAA;EACA,cAAA;EACA,mBAAA;EACA,wBAAA;EACA,uBAAA;EACA,mBAAA;EACA,uBAAA;ACCF;;ADEA;EACE,gBAAA;ACCF;;ADEA;EACE,cAAA;EACA,WAAA;EACA,YAAA;ACCF;;ADEA;EACE,eAAA;ACCF;;AC3BA;EACE,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AD8BF;;AC3BA;EACE,aAAA;AD8BF;;AC3BA;EACE,8BAAA;EACA,kBAAA;AD8BF;AC5BE;EACE,kBAAA;AD8BJ;;AC1BA;EACE,kBAAA;EACA,SAAA;EACA,UAAA;EACA,2BAAA;AD6BF;AC3BE;EACE,mBAAA;AD6BJ;;ACzBA;EACE,iBAAA;EACA,eAAA;EACA,gCAAA;AD4BF;;ACzBA;EACE,iBAAA;EACA,cCvCK;EDwCL,iBAAA;EACA,kBAAA;AD4BF;;ACzBA;EACE,sBAAA;AD4BF;;ACzBA;EACE,yBAAA;AD4BF;;ACzBA;EACE,yBAAA;EACA,sBAAA;EACA,0BAAA;AD4BF;;ACzBA;EACE,eAAA;AD4BF;;ACzBA;EACE,kBAAA;EACA,SAAA;EACA,0BAAA;AD4BF;;ACxBE;EACE,cAAA;AD2BJ;;ACvBA;EACE,kBAAA;EACA,iBAAA;AD0BF;;ACvBA;EACE,cAAA;AD0BF;;ACvBA;EACE,aAAA;EACA,kBAAA;EACA,WAAA;EACA,QAAA;EACA,iBAAA;EACA,cCzFK;ED0FL,YAAA;EACA,YAAA;EACA,aAAA;EACA,kBAAA;EACA,eAAA;EACA,kCAAA;EACA,kBAAA;AD0BF;;ACvBA;EACE,UAAA;EACA,mBAAA;EACA,sCAAA;EACA,gBAAA;AD0BF;ACxBE;EACE,cAAA;AD0BJ;ACvBE;EACE,mBAAA;EACA,eAAA;ADyBJ;;AGxIA;EACE,cAAA;EACA,gBAAA;EACA,kBAAA;EACA,iBAAA;EACA,yBAAA;AH2IF;;AGxIA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,iBAAA;EACA,yBAAA;EACA,WDVU;ECWV,YDXU;AFsJZ;;AGxIA;EACE,YDdW;ECeX,WDfW;ECgBX,mBAAA;EACA,kBAAA;EACA,gBAAA;AH2IF;;AGxIA;EACE,aAAA;AH2IF;;AGxIA;EACE,mBAAA;AH2IF;;AGxIA;EACE,YD/BU;ECgCV,WDhCU;ECiCV,mBDrCK;ECsCL,kBAAA;EACA,iBAAA;AH2IF;;AGxIA;EACE;IAAO,mBAAA;EH4IP;EG1IA;IAAO,mBAAA;EH6IP;AACF;AG3IA;EACE;IAAO,mBAAA;EH8IP;EG5IA;IAAO,mBAAA;EH+IP;AACF;AG7IA;EAEE,uBAAA;EACA,wBAAA;EACA,mBAAA;AH8IF;;AG3IA;EACE,iBAAA;AH8IF;;AG3IA;EACE,sBAAA;EACA,gBDjEW;ECkEX,gBAAA;AH8IF;AG5IE;EACE,gBDrES;ECsET,YDnES;ECoET,WDpES;ECqET,gBAAA;AH8IJ;;AAnNA;EACE,YAAA;EACA,mBEPK;EFQL,eAAA;EACA,4DAAA;AAsNF","sourcesContent":["* {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  outline: 0;\n  font: inherit;\n  font-size: inherit;\n  color: inherit;\n  text-align: inherit;\n  text-decoration: inherit;\n  vertical-align: inherit;\n  box-sizing: inherit;\n  background: transparent;\n}\n\nul {\n  list-style: none;\n}\n\nimg {\n  display: block;\n  width: 100%;\n  height: auto;\n}\n\nbutton {\n  cursor: pointer;\n}","@import './reset.scss';\n@import './constants.scss';\n@import './header.scss';\n@import './grid.scss';\n\nbody {\n  color: white;\n  background: $blue;\n  font-size: 24px;\n  font-family: \"Segoe UI Symbol\", Helvetica, Arial, sans-serif;\n}","header {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  margin: 15px;\n}\n\n.top-nav, .bottom-nav, .links, .info-btns, .object-btns, .option-btns {\n  display: flex;\n}\n\n.top-nav {\n  justify-content: space-between;\n  position: relative;\n\n  a {\n    margin-right: 10px;\n  }\n}\n\n.bottom-nav {\n  position: absolute;\n  top: 47px;\n  right: 50%;\n  transform: translate(575px);\n\n  button {\n    white-space: nowrap;\n  }\n}\n\nh1.center {\n  font-weight: bold;\n  font-size: 32px;\n  transform: translate(-50%, -5px);\n}\n\nbutton {\n  padding: 5px 15px;\n  color: $blue;\n  background: white;\n  border-radius: 5px;\n}\n\n.button {\n  box-shadow: 0 7px #999;\n}\n\n.button:hover {\n  background-color: #eeeeee;\n}\n\n.button:active, button.selected {\n  background-color: #eeeeee;\n  box-shadow: 0 4px #666;\n  transform: translateY(4px);\n}\n\n#start-btn {\n  margin: 0 100px;\n}\n\n.center {\n  position: absolute;\n  left: 50%;\n  transform: translate(-50%);\n}\n\n.object-btns, .option-btns {\n  > div {\n    margin: 0 10px;\n  }\n}\n\n.dropdown-ctnr {\n  position: relative;\n  margin-left: 10px;\n}\n\n.dropdown-ctnr:hover .dropdown {\n  display: block;\n}\n\n.dropdown {\n  display: none;\n  position: absolute;\n  z-index: 10;\n  right: 0;\n  background: white;\n  color: $blue;\n  width: 300px;\n  height: auto;\n  padding: 10px;\n  border-radius: 5px;\n  font-size: 18px;\n  box-shadow: 0px 0px 10px -3px gray;\n  text-align: center;\n}\n\n.dropdown.search {\n  padding: 0;\n  white-space: nowrap;\n  transform: translate(calc(50% - 36px));\n  overflow: hidden;\n\n  li {\n    padding: 5px 0;\n  }\n\n  li:hover {\n    background: rgb(226, 226, 226);\n    cursor: pointer;\n  }\n}","$blue: rgb(18, 64, 124);\n$grid-border: rgb(190, 245, 255);\n$wall-color: gray;\n\n$node-size: 25px;\n$swept-size: 15px;","#grid {\n  margin: 0 auto;\n  margin-top: 76px;\n  width: max-content;\n  background: white;\n  border: 1px solid $grid-border;\n}\n\n.node {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: white;\n  border: 1px solid $grid-border;\n  width: $node-size;\n  height: $node-size;\n}\n\n.swept div {\n  height: $swept-size;\n  width: $swept-size;\n  background: #ffdfc2;\n  border-radius: 50%;\n  transition: 0.2s;\n}\n\n.row {\n  display: flex;\n}\n\n.home {\n  background: rgb(71, 161, 139);\n}\n\n.sweepa div {\n  height: $node-size;\n  width: $node-size;\n  background: $blue;\n  border-radius: 50%;\n  transition: 0.05s;\n}\n\n@keyframes visited {\n  0%   { background: rgb(30, 60, 228) }\n  // 50%  { background: rgb(99, 48, 180) }\n  100% { background: rgb(251, 197, 249) }\n}\n\n@keyframes visited {\n  0%   { background: rgb(30, 198, 228) }\n  // 50%  { background: rgb(99, 48, 180) }\n  100% { background: rgb(47, 98, 238) }\n}\n\n.visited {\n  // transition: 0.3s;\n  animation-name: visited;\n  animation-duration: 1.5s;\n  background: rgb(47, 98, 238);\n}\n\n.return {\n  background: white;\n}\n\n.wall {\n  border: 1px solid $wall-color;\n  background: $wall-color;\n  transition: 0.2s;\n  \n  div {\n    background: $wall-color;\n    height: $swept-size;\n    width: $swept-size;\n    transition: 0.2s;\n  }\n}"],"sourceRoot":""}]);
// Exports
